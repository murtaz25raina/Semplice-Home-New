...
const SectionSeven = () => {
  return (
    <div className="section-seven-container">
      <div className="divider-text-container-section-seven">
        <span className="create-something-original">
          CREATE SOMETHING ORIGINAL
        </span>
        <span className="divider-section-seven"></span>
      </div>
      <div className="customise-everything">Customise Everything</div>
      <div className="modules-andlayout-blocks">
        <sup>2</sup>Modules and layout blocks provide an easy
        <br />
        starting point. Drop your work inside,
        <br />
        customize and make it your own.
      </div>
      <div className="create-something-original-grid">
